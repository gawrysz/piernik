   ...
   subroutine init_global
      ...
      select case (divB_0)
         ...
         case ("HDC", "hdc", "GLM", "glm", "divergence cleaning", "divergence diffusion")
            ...
            if (master .and. .false.) &
                 call warn("[global:init_global] In case of problems with stability connected with checkerboard pattern in the psi field consider reducing CFL parameter (or just CFL_GLM)." &
                 // " This solver also doesn't like sudden changes of timestep length.")
