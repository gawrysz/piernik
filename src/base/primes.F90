   ...
   subroutine print(this)
      ...
      if (master) then
         if (ubound(this%tab, 1) <= 0) then
            ...
            write(frmt, '(a,i0,a)')'(a,i0,a,i0,a,', ubound(this%tab, 1), '(" ",i0))'
            write(msg, frmt) "There are ", size(this%tab), " prime numbers equal to or smaller than ", this%max," :", this%tab
         else
            write(frmt, '(a,2(i0,a))')'(a,i0,a,i0,a,', head_primenum, '(" ",i0),a,', tail_primenum, '(" ",i0))'
            write(msg, frmt) "There are ", size(this%tab), " prime numbers equal to or smaller than ", this%max," :", this%tab(1:head_primenum), " .. ", this%tab(ubound(this%tab, 1)-tail_primenum+1:ubound(this%tab, 1))
         endif
